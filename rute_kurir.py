...
st.set_page_config(page_title = "Simulasi Rute", layout="centered")
...
with st.container():
        ...
        urut_tgl=new['Tgl'].dt.strftime("%d-%b-%Y").drop_duplicates(keep='last').sort_values(ascending=True, inplace=True) 
